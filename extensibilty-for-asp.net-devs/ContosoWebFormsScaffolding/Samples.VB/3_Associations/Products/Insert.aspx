<%@ Page Title="ProductInsert" Language="VB" MasterPageFile="~/Site.Master" CodeBehind="Insert.aspx.vb" Inherits="Samples.Insert3" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="Samples.Product" DefaultMode="Insert"
